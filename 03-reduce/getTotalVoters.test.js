...
describe('getTotalVoters', () => {
  it('When the list contains voters who have voted and voters who have not, Then it should return the total number of voters', () => {
    // Arrange
    const VOTERS = [
  ...
  it('When the list has no voters, Then it should return 0', () => {
    // Arrange
    const NO_VOTERS = [
      { name: 'Kate', age: 25, hasVoted: false },
      { name: 'Sam', age: 20, hasVoted: false },
