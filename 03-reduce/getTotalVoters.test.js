...
describe('getTotalVoters', () => {
  it.todo(
    'When the list contains voters who have voted and voters who have not, Then it should return the total number of voters',
    () => {
      // Arrange
      // Act
  ...
  it.todo('When the list has no voters, Then it should return 0', () => {
    // Arrange
  ...
  it.todo(
    'When the list contains only voters who have voted, Then it should return the total number of voters',
    () => {
      // Arrange
      // Act
  ...
  it.todo('When the list is empty, Then it should return 0', () => {
    // Arrange
    const EMPTY_VOTERS = [];
    const expectedResult = 0;
    // Act
  ...
  it.todo(
    'When the list contains only one voter who has voted, Then it should return 1',
    () => {
      // Arrange
      // Act
      const result = getTotalVoters();
      // Assert
      expect(result).toEqual(expectedResult);
    },
  );
  ...
  it.todo(
    'When the list contains only one voter who has not voted, Then it should return 0',
    () => {
      // Arrange
      // Act
      // Assert
